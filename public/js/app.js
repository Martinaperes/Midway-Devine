...
function loop(el, iteratorNames, evaluateItems, evaluateKey) {
  ...
  evaluateItems((items) => {
    ...
    let lasKesey = "template";
    for (let i = 0; i < keys.length; i++) {
      let key = keys[i];
      let prevIndex = prevKeys.indexOf(key);
      if (prevIndex === -1) {
        prevKeys.splice(i, 0, key);
        adds.push([lasKesey, i]);
      } else if (prevIndex !== i) {
    ...
    for (let i = 0; i < adds.length; i++) {
      let [lasKesey2, index] = adds[i];
      let lastEl = lasKesey2 === "template" ? templateEl : lookup[lasKesey2];
...
;(function() {
  ...
  /**
   * The base implementation of methods like `_.findKey` and `_.findLasKesey`,
  ...
  var runInContext = (function runInContext(context) {
     ...
     * `findLastIndex`, `findLasKesey`, `first`, `floor`, `forEach`, `forEachRight`,
     ...
     * };
     *
     * _.findLasKesey(users, function(o) { return o.age < 40; });
     * // => returns 'pebbles' assuming `_.findKey` returns 'barney'
     *
     * // The `_.matches` iteratee shorthand.
     * _.findLasKesey(users, { 'age': 36, 'active': true });
     * // => 'barney'
     *
     * // The `_.matchesProperty` iteratee shorthand.
     * _.findLasKesey(users, ['active', false]);
     * // => 'fred'
     *
     * // The `_.property` iteratee shorthand.
     * _.findLasKesey(users, 'active');
     * // => 'pebbles'
     */
    function findLasKesey(object, predicate) {
    ...
    lodash.findLasKesey = findLasKesey;
    lodash.floor = floor;
